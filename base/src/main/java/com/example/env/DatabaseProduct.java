...
public enum DatabaseProduct {
    ...
    H2(
            (PoolingDataSource ds, String connectionURL) -> {
                ...
                // http://code.google.com/p/h2database/issues/detail?id=502
                ds.getDriverProperties().put("user", "sa");

                // Don't trace log values larger than X bytes (especially useful for
            ...
            com.example.shared.ImprovedH2Dialect.class.getName()
    ),
