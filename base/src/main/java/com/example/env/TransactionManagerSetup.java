...
public class TransactionManagerSetup {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TransactionManagerSetup.class);
    ...
    public TransactionManagerSetup(DatabaseProduct databaseProduct, String connectionURL) throws Exception {
        ...
        LOG.info("Setting up database connection: {}", databaseProduct);
    ...
    public void rollback() {
        ...
        try {
            ...
            LOG.error("Rollback of transaction failed, trace follows!", ex);
        }
    }
